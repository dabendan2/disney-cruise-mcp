...
async function testActivitiesOrchestration() {
    ...
    try {
        ...
        const sampleHtml = fs.readFileSync(path.join(__dirname, '../../fixtures/add_activities_sample.html'), 'utf8');
        ...
        const listHtml = fs.readFileSync(path.join(__dirname, '../../fixtures/activity_list.html'), 'utf8');
