...
async function runBookingLogicTests() {
    ...
    try {
        ...
        const errorSamplePath = path.join(__dirname, '../res/booking_error_system_unable.html');
        ...
        const readySamplePath = path.join(__dirname, '../res/booking_ready_to_save.html');
